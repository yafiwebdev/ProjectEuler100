...
function largestProductInASeries(n) {
	...
	let startIndex = 0;
	let endIndex = n - 1;
	// Index of the last digit in the array (Defined below function)
	let lastIndex = THOUSAND_DIGITS.length - 1;
	...
	while(endIndex <= lastIndex) {
		...
		for(; tmpStartIndex <= endIndex; tmpStartIndex++) {
			product *= THOUSAND_DIGITS[tmpStartIndex];
		}
